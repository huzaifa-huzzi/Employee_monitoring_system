import 'package:employee_monitoring_system/Panel/Employee/TimeSheet/ReusableWidget/PrimaryBtnOfTime.dart';
...
class CustomDatePickerCompanyDialog extends StatefulWidget {
  ...
  @override
  State<CustomDatePickerCompanyDialog> createState() => _CustomDatePickerCompanyDialogState();
}

class _CustomDatePickerCompanyDialogState extends State<CustomDatePickerCompanyDialog> {
  ...
  Widget build(BuildContext context) {
    final double screenWidth = AppSizes.screenWidth(context);
