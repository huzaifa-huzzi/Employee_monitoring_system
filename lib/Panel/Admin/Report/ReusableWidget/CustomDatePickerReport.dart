...
class CustomDatePickerReport extends StatefulWidget {
  final DateTime? initialDate;
  final VoidCallback onCancel;
  final Function(DateTime selectedDate) onDateSelected;

  const CustomDatePickerReport({
    super.key,
    this.initialDate,
  ...
  @override
  State<CustomDatePickerReport> createState() => _CustomDatePickerReportState();
}

class _CustomDatePickerReportState extends State<CustomDatePickerReport> {
