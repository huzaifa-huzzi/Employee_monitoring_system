...
class MobileAdminAppbar extends StatefulWidget implements PreferredSizeWidget {
  final VoidCallback onMenuTap;

  const MobileAdminAppbar({super.key, required this.onMenuTap});

  @override
  State<MobileAdminAppbar> createState() => _MobileAdminAppbarState();

  @override
  Size get preferredSize => const Size.fromHeight(60);
}

class _MobileAdminAppbarState extends State<MobileAdminAppbar> {
