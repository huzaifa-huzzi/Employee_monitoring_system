...
class TabletAdminAppbar extends StatefulWidget implements PreferredSizeWidget {
  final VoidCallback onMenuTap;

  const TabletAdminAppbar({super.key, required this.onMenuTap});

  @override
  State<TabletAdminAppbar> createState() => _TabletAppBarState();

  @override
  Size get preferredSize => const Size.fromHeight(70);
}

class _TabletAppBarState extends State<TabletAdminAppbar> {
            ...
            CompositedTransformTarget(
              ...
              child: OverlayPortal(
                ...
                overlayChildBuilder: (context) => CompositedTransformFollower(
                  ...
                  child: Align(alignment: Alignment.topLeft, child: _buildTimerPopup(SidebarAdminController())),
                ),
                child: InkWell(
  ...
  // Timer popup
  Widget _buildTimerPopup(SidebarAdminController controller) {
    return Material(
      elevation: 8,
  ...
  // SIGN OUT POPUP
  Widget _buildSignOutPopup(SidebarAdminController controller) {
    return Stack(
      children: [
