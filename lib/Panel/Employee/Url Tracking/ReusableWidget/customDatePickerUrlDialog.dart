...
class CustomDatePickerUrlDialog extends StatefulWidget {
  ...
  @override
  State<CustomDatePickerUrlDialog> createState() => _CustomDatePickerUrlDialogState();
}

class _CustomDatePickerUrlDialogState extends State<CustomDatePickerUrlDialog> {
