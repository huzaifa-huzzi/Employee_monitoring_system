...
class WeeklyActivityGraphWidget extends StatelessWidget {
  final ActivityController controller;

  const WeeklyActivityGraphWidget({super.key, required this.controller});
    ...
    return Obx(() {
      return BarChart(
        BarChartData(
            ...
            bottomTitles: AxisTitles(
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  if (index >= 0 && index < controller.weeklyGraphData.length) {
                    return Padding(
                      padding: const EdgeInsets.only(top: 8.0),
                      child: Text(
                        controller.weeklyGraphData[index].day,
                        style: const TextStyle(
                          color: AppColors.textColor,
          ...
          barGroups: controller.weeklyGraphData.asMap().entries.map((entry) {
            int index = entry.key;
