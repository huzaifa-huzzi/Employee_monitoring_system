...
class TabletVendorAppbar extends StatefulWidget implements PreferredSizeWidget {
  final VoidCallback onMenuTap;

  const TabletVendorAppbar({super.key, required this.onMenuTap});

  @override
  State<TabletVendorAppbar> createState() => _TabletVendorAppbarState();

  @override
  Size get preferredSize => const Size.fromHeight(70);
}

class _TabletVendorAppbarState extends State<TabletVendorAppbar> {
            ...
            CompositedTransformTarget(
              ...
              child: OverlayPortal(
                ...
                overlayChildBuilder: (context) => CompositedTransformFollower(
                  ...
                  child: Align(alignment: Alignment.topLeft, child: _buildTimerPopup(SidebarVendorController())),
                ),
                child: InkWell(
