...
class CustomDatePickerSnapShot extends StatefulWidget {
  ...
  @override
  State<CustomDatePickerSnapShot> createState() => _CustomDatePickerSnapShotState();
}

class _CustomDatePickerSnapShotState extends State<CustomDatePickerSnapShot> {
