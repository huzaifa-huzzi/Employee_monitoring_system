...
class CustomPickerUrlTracker extends StatefulWidget {
  ...
  @override
  State<CustomPickerUrlTracker> createState() => _CustomPickerUrlTrackerState();
}

class _CustomPickerUrlTrackerState extends State<CustomPickerUrlTracker> {
