...
class TextString{
   ...
   static const String  adminReportDetailStatus=   "Status";
    ...
    /// Subscription
   static const String  adminSubscriptionTitle=   "Subscription";
   static const String  adminSubscriptionSubtitle= "Your subscription detail is given below";
   static const String  adminAllSubscription=    "All Subscriptions";
   static const String  adminSubscriptionKpiOne= "Total New Subscriptions";
   static const String  adminSubscriptionKpiTwo=  "3 more subscriber Added";
   static const String  adminSubscriptionKpiThree=  "Total Weekly Subscriptions";
   static const String  adminSubscriptionKpiFour=   "3 more subscriber Added";
   static const String  adminSubscriptionKpiFive= "Total Monthly Subscriptions";
   static const String  adminSubscriptionKpiSix=  "3 more subscriber Added";
   static const String  adminSubscriptionKpiSeven=  "Total Yearly Subscriptions";
   static const String  adminSubscriptionKpiEight=   "3 more subscription Added";
   static const String  adminSubscriptionFieldText=  "Search by Company Name";
   static const String  adminSubscriptionTableOne=  "Company Name";
   static const String  adminSubscriptionTableTwo=  "Plan";
   static const String  adminSubscriptionTableThree=  "Cycle";
   static const String  adminSubscriptionTableFour=  "Start Date";
   static const String  adminSubscriptionTableFive=  "End Date";
   static const String  adminSubscriptionTableSix=  "Pricing";
   static const String  adminSubscriptionTableSeven=  "Status";
   static const String  adminSubscriptionTableEight=  "Action";
   static const String  adminSubscriptionErrorText=  "No Subscriptions Found";
   static const String  adminSubscriptionGeneralTitle=  "General Information";
   static const String  adminSubscriptionGeneralSubtitle=  "Basic detail about the company";
   static const String  adminSubscriptionGeneralOne=  "Company Logo";
   static const String  adminSubscriptionGeneralTwo=  "Company Name";
   static const String  adminSubscriptionGeneralThree=  "Account Status";
   static const String  adminSubscriptionGeneralFour=  "Phone Number";
   static const String  adminSubscriptionGeneralFive=  "Email Address";
   static const String  adminSubscriptionGeneralSix=  "Email Status";
   static const String  adminSubscriptionGeneralSeven=  "Address";
   static const String  adminSubscriptionGeneralEight=  "Number of Employees";
   static const String  adminSubscriptionGeneralNine=  "Joining Date";
   static const String  adminSubscriptionSubscribeTitle=  "Subscription Information";
   static const String  adminSubscriptionSubscribeSubtitle=  "Company subscription listed here";
   static const String  adminSubscriptionSubscribeOne=  "Plan";
   static const String  adminSubscriptionSubscribeTwo=  "Start Date";
   static const String  adminSubscriptionSubscribeThree=  "End Date";
   static const String  adminSubscriptionSubscribeFour=  "Payment Status";
   static const String  adminSubscriptionSubscribeFive=  "Remaining Days";
   static const String  adminSubscriptionInvoiceTitle=  "All Invoices";
   static const String  adminSubscriptionTitleTwo=  "Invoices Detail";
   static const String  adminSubscriptionSubtitleTwo=   "Your subscription detail is given below";
   static const String  adminSubscriptionInvoiceTableOne=  "Invoice ID";
   static const String  adminSubscriptionInvoiceTableTwo=  "Payment Date";
   static const String  adminSubscriptionInvoiceTableThree=  "Billing Period";
   static const String  adminSubscriptionInvoiceTableFour=  "Amount";
   static const String  adminSubscriptionInvoiceTableFive=  "Method";
   static const String  adminSubscriptionInvoiceError=  "No records found";
   static const String  adminSubscriptionInvoiceThanks=   "Thanks for your Business";
   static const String  adminSubscriptionPdf=  "Download PDF";
   static const String  adminSubscriptionEmail=  "Send Email";
   static const String  adminSubscriptionPrint=  "Print";
   static const String  adminSubscriptionOriginalRecipient=   "Original For Recipient";
   static const String  adminSubscriptionInvoice=  "TAX INVOICE";
   static const String  adminSubscriptionDate=  "Date: ";
   static const String  adminSubscriptionDateTwo=  "05/12/2024";
   static const String  adminSubscriptionInvoiceNo=  "Invoice No: ";
   static const String  adminSubscriptionInvoiceNoMain=  "INV 00001";
   static const String  adminSubscriptionInvoiceTo=  "Invoice To :";
   static const String  adminSubscriptionName=  "Walter Roberson";
   static const String  adminSubscriptionAddress=  "92 the Avenue, Alexander Heights 6064.";
   static const String  adminSubscriptionPayto=  "Pay To :";
   static const String  adminSubscriptionpayName=  "Lowell H. Dominguez";
   static const String  adminSubscriptionpayAddress=  "84 Spilman Street, London United King";
   static const String  adminSubscriptionpayEmail=  "domlowell@gmail.com";
   static const String  adminSubscriptionITem=  "Item";
   static const String  adminSubscriptionPrice= "Price" ;
   static const String  adminSubscriptionActiveEmployee=  "Active Employees";
   static const String  adminSubscriptionActiveEmployeeSubtitle=  "Rate per Employee";
   static const String  adminSubscriptionActiveEmployeeOne=  "20.00";
   static const String  adminSubscriptionActiveEmployeeTwo=  "\$8.00";
   static const String  adminSubscriptionImportant=  "Important Note:";
   static const String  adminSubscriptionImportantSubtitle=   "Payments are verified after receipt. Subscription renewals are activated once the payment has been successfully confirmed.";
   static const String  adminSubscriptionTaxable=  "Taxable Amount ";
   static const String  adminSubscriptionTaxableSubtitle=  "\$20.00";
   static const String  adminSubscriptionDiscount=  "Discount 0% ";
   static const String  adminSubscriptionDiscountSubtitle=  "+ \$0.00";
   static const String  adminSubscriptionTotalItems=  "Total Items / Qty : 4 / 4.00";
   static const String  adminSubscriptionTotal=  "Total";
   static const String  adminSubscriptionTotalAmount=   "Total amount ( in words): One Hundred Eighty Dollars Only";
   static const String  adminPaymentInfo=  "Payment Info:";
   static const String  adminPaymentInfoSubtitle=  "Debit Card : 465 *************645";
   static const String  adminPaymentSoftSnip=  "From Soft Snip";
   static const String  adminSubscriptionSignature=  "James Paulo";
   static const String  adminSubscriptionTerms=  "Terms & Conditions :";
